# Script to login as admin and test product creation with image fields
Write-Host "=== Login as admin and test product creation with image fields ===" -ForegroundColor Green
...
try {
    ...
    # 2. Get categories to use a valid categoryId
