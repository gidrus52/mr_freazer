export default function telegramIcon({fillColor,width, height}) {
    return (

        <svg width={width} height={height} fill={fillColor} viewBox="0 0 48 48" id="Layer_2" data-name="Layer 2"
